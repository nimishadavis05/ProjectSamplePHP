...
<!-- Mirrored from demo.themefisher.com/themefisher/fame/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Jun 2020 05:04:28 GMT -->
<head>
...
while($sql1=mysqli_fetch_array($result,MYSQLI_NUM))
{
    ...
    echo '<img src="'.$sql1[3].'" class="img-responsive" alt="" />';
    echo '<div class="portfolio-caption">';
    echo '<h4>'.$sql1[1].'</h4>';
  
   echo '<a href="'.$sql1[2].'" class="link-2"><i class="fa fa-link"></i></a>';
                                    echo"</div>";
                                echo"</div>";
                            echo"</li>";
}
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <span class="copyright">Copyright &copy; Fame 2015</span>
                    </div>
                    <div class="col-md-4 col-xs-12">
...
<!-- Mirrored from demo.themefisher.com/themefisher/fame/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Jun 2020 05:05:44 GMT -->
</html>
